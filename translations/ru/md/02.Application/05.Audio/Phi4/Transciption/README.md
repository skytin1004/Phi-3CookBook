...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-03-27T13:09:02+00:00",
  "source_file": "md\\02.Application\\05.Audio\\Phi4\\Transciption\\README.md",
  "language_code": "ru"
}
-->
## **Извлечение аудиотранскрипций с помощью Phi-4-multimodal**

Phi-4-multimodal — это полноформатная модель, которая может работать с аудио, а также с текстом и изображениями. Давайте посмотрим, как её использовать.
