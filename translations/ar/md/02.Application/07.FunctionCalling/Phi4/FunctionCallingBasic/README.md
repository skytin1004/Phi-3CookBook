...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-03-27T13:16:14+00:00",
  "source_file": "md\\02.Application\\07.FunctionCalling\\Phi4\\FunctionCallingBasic\\README.md",
  "language_code": "ar"
}
-->
## **استدعاء الدوال في Phi-4-mini**

ظهر استدعاء الدوال لأول مرة في عائلة Phi، والآن يمكنك استخدامه عبر Phi-4-mini.

يوضح هذا المثال محاكاة نتائج الدوري الإنجليزي الممتاز. الهدف هو أن يوفر Phi-4-mini معلومات المباريات في الوقت الفعلي. فيما يلي الكود النموذجي:
