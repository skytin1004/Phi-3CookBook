...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-03-27T13:17:13+00:00",
  "source_file": "md\\02.Application\\07.FunctionCalling\\Phi4\\FunctionCallingBasic\\README.md",
  "language_code": "fa"
}
-->
## **فراخوانی تابع در Phi-4-mini**

فراخوانی تابع اولین بار در خانواده Phi معرفی شد، و اکنون می‌توانید از آن در Phi-4-mini استفاده کنید.

این مثال شبیه‌سازی نتایج لیگ برتر را نشان می‌دهد. هدف این است که Phi-4-mini اطلاعات بازی‌ها را به صورت لحظه‌ای ارائه دهد. نمونه کد در زیر آمده است:
...
**سلب مسئولیت**:  
این سند با استفاده از خدمات ترجمه هوش مصنوعی [Co-op Translator](https://github.com/Azure/co-op-translator) ترجمه شده است. در حالی که ما برای دقت تلاش می‌کنیم، لطفاً توجه داشته باشید که ترجمه‌های خودکار ممکن است حاوی اشتباهات یا نواقصی باشند. سند اصلی به زبان بومی آن باید به عنوان منبع معتبر در نظر گرفته شود. برای اطلاعات حیاتی، ترجمه حرفه‌ای انسانی توصیه می‌شود. ما مسئولیتی در قبال هرگونه سوءتفاهم یا تفسیر نادرست ناشی از استفاده از این ترجمه نداریم.