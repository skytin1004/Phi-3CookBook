...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-03-27T12:05:33+00:00",
...
En Visual Studio Code Copilot Chat, puedes gestionar todo el proyecto a través de @workspace. Para escenarios empresariales, también podemos personalizar de manera más flexible el agente de Copilot Chat.

En el último laboratorio, combinamos NPU y la nube para completar una extensión de Visual Studio Code para el agente Phi3.

![agent](../../../../../../../../../translated_images/vscode_agent.409cc20073ede69c5bd4db0d611aff68cf40ed88d8c334a899a341c6ba82f013.es.png)
...
***NOTA:*** Por favor, utiliza Typescript y WebPack como solución técnica para este proyecto.
...
¡Felicidades! Has completado todos los laboratorios. Espero que esto te ayude a comprender la familia Phi-3 y cómo utilizar GitHub Copilot Chat.

Puedes probar ***@PHI3 /gen*** 

![code](../../../../../../../../../translated_images/result_code.b7f0a05d87a4531ebe53c74c970c001ce999243d78da4350d54087672c9b2e61.es.png)

Puedes probar ***@PHI3 /img*** 

![img](../../../../../../../../../translated_images/result_img.2e6e2a54453cccd463d90fc594ccf4597b162471c76f9597bb967afa4bd6de77.es.png)

**Descargo de responsabilidad**:  
Este documento ha sido traducido utilizando el servicio de traducción automática [Co-op Translator](https://github.com/Azure/co-op-translator). Aunque nos esforzamos por lograr precisión, tenga en cuenta que las traducciones automatizadas pueden contener errores o imprecisiones. El documento original en su idioma nativo debe considerarse como la fuente autorizada. Para información crítica, se recomienda la traducción profesional realizada por humanos. No somos responsables de malentendidos o interpretaciones erróneas que surjan del uso de esta traducción.