...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-03-27T12:30:08+00:00",
  "source_file": "md\\02.Application\\02.Code\\Phi3\\VSCodeExt\\HOL\\Apple\\04.CreatePhi3AgentInVSCode.md",
  "language_code": "es"
}
-->
# **Laboratorio 3 - Crear un agente @PHI3 en GitHub Copilot Chat**
...
La API de Visual Studio Code Chat aún no se ha integrado en la API de código, pero ahora se añade mediante extensiones.
...
Puedes ejecutar **npm install** en el terminal y depurar tu extensión para probarla.
...
¡Felicidades! Has completado todos los laboratorios. Espero que esto te ayude a entender la Familia Phi-3 y cómo utilizar GitHub Copilot Chat.
